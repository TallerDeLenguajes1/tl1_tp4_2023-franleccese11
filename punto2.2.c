...
void searchTask(Tarea **task,Tarea **task_completed,int id,int id_searched);
...
void searchTask(Tarea **task,Tarea **task_completed,int id,int id_searched){
    ...
    if (*task_completed != NULL)
    {
        ...
        if((*task_completed)->TareaID == id_x ) {
            printf("su tarea solicitada fue encontrada\n");
            printf("La tarea se encuentra entre la lista de tareas realizadas\n");
            printf("descripcion de la tarea:");
            puts((*task_completed)->Descripcion);
        }
    }
